...
const Chat = () => {
  ...
  return (
    ...
    >
      <div
        class="card-body chatB"
        style={{ height: "100%", position: "fixed", marginTop: "20%" }}
      >
        <div className="chatInside">
          ...
          {messages.map((message, i) => (
            <div
              className={message.sender === "AI" ? "chatLeft" : "chatRight"}
              style={i === messages.length - 1 ? { marginBottom: "10%" } : null}
            >
              {message.sender === "AI" ? (
                <div className="image">
              ...
              <div className={message.sender === "AI" ? "aBody" : "uBody"}>
                <div
                  className={message.sender === "AI" ? "aContent" : "uContent"}
                >
                  <div>
                    {" "}
                    {isTyping &&
                ...
                <small
                  className={
                    message.sender === "AI" ? "chat-date" : "uchat-date"
                  }
                >
                  <i
                    className={
                      message.sender === "AI"
                        ? "tf-icons bx bx-calendar"
                        : " bx bx-calendar"
                    }
                  ></i>{" "}
                  22-07-2023 at 09:00
        ...
        <div class=" byr">
          ...
          <div className="add">
            ...
            >
              <span
                class={isTyping ? "tf-icons bx bx-stop" : "tf-icons bx bx-send"}
                style={{ fontSize: "32px" }}
              ></span>
            </button>
          </div>
